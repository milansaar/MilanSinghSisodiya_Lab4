...
Sol1: CREATE TABLE IF NOT EXISTS supplier(
...
Sol2: INSERT INTO SUPPLIER VALUES(1,"Rajesh Retails","Delhi",'1234567890');
...
FROM
    order1 o
JOIN
    product p ON o.PRICING_ID = p.PRO_ID
WHERE
